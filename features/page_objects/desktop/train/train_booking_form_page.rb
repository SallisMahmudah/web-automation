...
class BookingFormTrainPage < SitePrism::Page
    ...
    elements :booking_born_date_section,                  ".dummy-input.date-only"
    elements :booking_born_date_field,                    ".input-date"
    elements :booking_born_month_field,                   ".input-month"
    elements :booking_born_year_field,                    ".input-year"
